            ...
            {customers.length === 0 ? (
              ...
              customers.map((c, i) => (
                <tr key={i} style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <td style={{ padding: '14px 16px' }}>
                    <a href={'https://wa.me/' + c.customer_phone} target="_blank" rel="noreferrer" style={{ padding: '5px 10px', background: 'rgba(37,211,102,0.2)', border: '1px solid rgba(37,211,102,0.4)', borderRadius: '6px', color: '#4ade80', fontSize: '12px', textDecoration: 'none' }}>💬 Message</a>
                  </td>
                </tr>
              ))
            )}
